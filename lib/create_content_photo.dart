...
class create_content_photo extends StatefulWidget{
  @override
...
class _create_content extends State<create_content_photo> {
  var _currencies = [
    "Delhi",
    "Uttar Pradesh",
    "Mumbai",
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Text("Upload Image ( PNG/JPEG/ JPG)",style: TextStyle(
                        color: Colors.black,
                        fontFamily: "poppins",
                      ),)),
                ],
